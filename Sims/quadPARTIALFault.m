...
%             phi_vd,phid,phi_v(t),phi(t),theta_vd,thetad,theta_v(t),theta(t),psi_vd,psid,psi_v(t),psi(t));
    ...
    title('Observed Motor Speed after Correction',FontSize=22);
    ylabel('Motor Speed)');
    xlabel('Time (s)');
    axis([0 80 0 2000]);
    grid;
    ...
    ax = gca;
    ax.FontSize = 14;
    legend('w1eff','w2eff','w3eff','w4eff','Location','northwest');
    title('Effective Motor Speed for Faulty Motor',FontSize=22);
    ylabel('Motor Speed');
    xlabel('Time (s)');
    axis([00 80 0 2001]);
    grid;
